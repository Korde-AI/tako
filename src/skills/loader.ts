...
export class SkillLoader {
  ...
  private async parseManifest(
    ...
    return {
      ...
      commandDispatch: meta['command-dispatch'] === 'tool' ? 'tool' : undefined,
      commandTool: meta['command-tool'] || undefined,
      commandArgMode: meta['command-arg-mode'] === 'raw' ? 'raw' : undefined,
